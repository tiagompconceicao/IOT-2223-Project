...
#            lat_string = str(self._latitude[0]) + '° ' + str(self._latitude[1]) + "' " + str(self._latitude[2])
            lat_string = str(self._latitude[0]) + str(self._latitude[2] + str(self._latitude[1]))
        return lat_string
...
#            lon_string = str(self._longitude[0]) + '° ' + str(self._longitude[1]) + "' " + str(self._longitude[2])
            lon_string = str(self._longitude[0]) + str(self._longitude[2] + str(self._longitude[1]))
        return lon_string
    ...
    def time_string(self, ):
        """
        Creates a readable string of the current UTC time.
        :return: time_string  string
        """
        hours=self.timestamp[0]
        minutes=self.timestamp[1]
        seconds=self.timestamp[2]
        tstr='{:02d}:{:02d}:{:02d}'.format(hours,minutes,int(seconds))
        return tstr
